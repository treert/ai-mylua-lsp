...
print(abc)"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(1, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
print(abcd)"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(6, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
fn hover_emmy_class_return_type() {
    ...
    let result = hover::hover(doc, intern(&uri), pos(21, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
local a1_test = test()"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(10, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
fn hover_chain_call() {
    ...
    let result = hover::hover(doc, intern(&uri), pos(30, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
fn hover_fixture_hover5_alias() {
    ...
    let result = hover::hover(doc, intern(&uri), pos(8, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
fn hover_no_result_on_keyword() {
    ...
    let result = hover::hover(doc, intern(&uri), pos(0, 0), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
local x = UMiscSystemLibrary"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(4, 0), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
function MyObj.doSomething(x) end"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(7, 15), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
function greet(name) end"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(2, 9), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
local y = doSomething("hello")"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(7, 10), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
print(x)"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(3, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
x.bar = 1"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(3, 0), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
local _ = a.b.c"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(7, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
obj.qux = 1"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(3, 4), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
return test_const"#,
    ...
    let main_doc = docs.get(&intern(&main_uri)).expect("main doc");
    ...
    let result = hover::hover(main_doc, intern(&main_uri), pos(0, 23), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
return settings"#,
    ...
    let result = hover::hover(main_doc, intern(&main_uri), pos(1, 15), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(2, 13), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(0, 9), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    if let Some(h) = result {
        let content = hover_content_string(&h);
        assert!(
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(2, 11), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    if let Some(h) = result {
        let content = hover_content_string(&h);
        assert!(
    ...
    let tail = hover::hover(doc, intern(&uri), pos(2, 13), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
"#;
    ...
    let h_a = hover::hover(doc, intern(&uri), pos(4, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
        .expect("hover on a");
    ...
    let h_b = hover::hover(doc, intern(&uri), pos(5, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
        .expect("hover on b");
...
"#;
    ...
    let h_a = hover::hover(doc, intern(&uri), pos(4, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs)).expect("hover on a");
    let text_a = hover_content_string(&h_a);
    assert!(text_a.contains("number"), "a should be number, got:\n{}", text_a);

    // `b` must not falsely claim `number`.
    if let Some(h) = hover::hover(doc, intern(&uri), pos(5, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs)) {
...
"#;
    ...
    if let Some(h) = hover::hover(doc, intern(&uri), pos(4, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs)) {
...
"#;
    ...
    if let Some(h) = hover::hover(doc, intern(&uri), pos(8, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs)) {
        let text = hover_content_string(&h);
        assert!(
            !text.contains("`number`") && !text.contains("Type: number"),
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(4, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let h = hover::hover(doc, intern(&uri), pos(2, 10), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let h = hover::hover(doc, intern(&uri), pos(3, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let h = hover::hover(doc, intern(&uri), pos(7, 13), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let _ = hover::hover(doc, intern(&uri), pos(2, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
}
...
"#;
    ...
    let h = hover::hover(doc, intern(&uri), pos(3, 8), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    // `.` is col 7, `x` is col 8).
    let h = hover::hover(doc, intern(&uri), pos(5, 8), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(11, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(2, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(9, 14), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    ...
    let result2 = hover::hover(doc, intern(&uri), pos(10, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(9, 3), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(7, 2), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(2, 18), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let main_uri = make_uri("main.lua");
    let main_doc = docs.get(&intern(&main_uri)).unwrap();

    // hover on `add` in `math_utils.add(1, 2)` — line 1, col 23 is `add`
    let result = hover::hover(main_doc, intern(&main_uri), pos(1, 23), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    ...
    let result2 = hover::hover(main_doc, intern(&main_uri), pos(2, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(result2.is_some(), "hover on `sum` should succeed");
    let text2 = hover_content_string(result2.as_ref().unwrap());
    assert!(
        text2.contains("number"),
...
"#;
    ...
    let result = hover::hover(main_doc, intern(&main_uri), pos(1, 3), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(main_doc, intern(&main_uri), pos(1, 20), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        result.is_some(),
    ...
    let result2 = hover::hover(main_doc, intern(&main_uri), pos(1, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    ...
    let result3 = hover::hover(main_doc, intern(&main_uri), pos(2, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
"#;
    ...
    let result = hover::hover(main_doc, intern(&main_uri), pos(2, 7), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        result.is_some(),
    ...
    let result2 = hover::hover(main_doc, intern(&main_uri), pos(3, 7), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        result2.is_some(),
...
local a1 = ClassA1:new()"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(13, 19), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        result.is_some(),
...
local a1 = ClassA1:new()"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(13, 6), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
local value = Phantom:new()"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(13, 22), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(4, 20), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let result = hover::hover(doc, intern(&uri), pos(3, 20), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        result.is_none(),
...
"#;
    ...
    let param_desc = hover::hover(doc, intern(&uri), pos(6, 20), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        param_desc.is_none(),
        "unmarked @param description words must not act as type references"
    );

    let class_desc = hover::hover(doc, intern(&uri), pos(9, 25), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        class_desc.is_none(),
...
"#;
    ...
    let table_key = hover::hover(doc, intern(&uri), pos(6, 11), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        table_key.is_none(),
        "table field keys in type expressions must not act as type references"
    );

    let bracket_key = hover::hover(doc, intern(&uri), pos(10, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs))
...
"#;
    ...
    let literal_word = hover::hover(doc, intern(&uri), pos(3, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        literal_word.is_none(),
        "string literal contents must not act as type references"
    );

    let key_word = hover::hover(doc, intern(&uri), pos(6, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
        key_word.is_none(),
        "string table keys must not act as type references"
    );

    let escaped_word = hover::hover(doc, intern(&uri), pos(9, 12), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
...
"#;
    ...
    let result_global = hover::hover(doc, intern(&uri), pos(23, 4), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
    ...
    let result_local = hover::hover(doc, intern(&uri), pos(24, 4), &mut agg, &mylua_lsp::document::DocumentStoreView::new(&docs));
    assert!(
