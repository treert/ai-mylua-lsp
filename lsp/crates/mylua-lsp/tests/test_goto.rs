...
"#;
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(2, 10), &mut agg, &GotoStrategy::Auto);
    assert!(
        result.is_some(),
...
print(myVar)"#;
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(1, 6), &mut agg, &GotoStrategy::Auto);
...
local x = foo()"#;
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(3, 10), &mut agg, &GotoStrategy::Auto);
...
fn goto_parameter() {
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(1, 10), &mut agg, &GotoStrategy::Auto);
...
fn goto_no_result_for_undefined() {
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(0, 10), &mut agg, &GotoStrategy::Auto);
...
fn goto_require_jumps_to_module_return() {
    ...
    let caller_uri_id = intern(&caller_uri);
    ...
    let result = mylua_lsp::goto::goto_definition(
        &caller_doc, intern(&caller_uri), pos(0, 6), &mut agg, &GotoStrategy::Auto)
...
fn goto_require_with_attribute_before_target() {
    ...
    let result =
        goto::goto_definition(&caller_doc, intern(&caller_uri), pos(0, 17), &mut agg, &GotoStrategy::Auto)
...
fn goto_position_with_chinese_comment_on_same_line() {
    ...
    let result = goto::goto_definition(&doc, intern(&uri), pos(2, 6), &mut agg, &GotoStrategy::Auto);
...
do
    ...
    let result2 = goto::goto_definition(&doc, intern(&uri), pos(4, 10), &mut agg, &GotoStrategy::Auto);
...
local hero = Player.new("Alice")"#;
    ...
    let result = goto::goto_definition(
        &caller_doc, intern(&caller_uri), pos(1, 20), &mut agg, &GotoStrategy::Auto) ;
    assert!(
        result.is_some(),
