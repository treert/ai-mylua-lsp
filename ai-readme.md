...
| `test_workspace_symbol.rs` | 5 | `@field bar` 带 container_name、跨文件同名字段各自带 container、`function Foo:m` 拆成 METHOD + container_name、普通 global function 无 container、class 本身 CLASS 可搜 |
